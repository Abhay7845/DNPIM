...
import './MuliSelectDropdownField.css'
...
export const MuliSelectDropdownFieldQualityFeedback = (props) => {
    ...
    //console.log(props,"multiSelectDrop")
        ...
        const dataQlty =[
            {
                valueData: "Antique,Rhodium,Enamel Issues", lableValue: "Not Relevant To Market"
            },
            {
                valueData: "Diamond Visibility not ok", lableValue: "Diamond Visibility not ok"
            },
            {
                valueData: "Fall and Linking Issues", lableValue: "Fall and Linking Issues"
            },
            {
                valueData: "Finding Quality Issues-Screw,Hooks,etc..", lableValue: "Finding Quality Issues-Screw,Hooks,etc.."
            },
            {
                valueData: "Higne and Lock issues in Babgle", lableValue: "Higne and Lock issues in Babgle"
            },
            {
                valueData: "Sharp edges and Soldering Quality issues", lableValue: "Sharp edges and Soldering Quality issues"
            },
            {
                valueData: "Stone setting related issues", lableValue: "Stone setting related issues"
            },
            {
                valueData: "Surface finish and intricate area finish not ok", lableValue: "Surface finish and intricate area finish not ok"}]
